...
(function (undefined, angular, $) {
  ...
  angular.module('com.ivarprudnikov.ng.validation', [])
        ...
        controller : ['$scope', function ($scope) {
          ...
          this.needsAttention = function (fieldModelController) {
            ...
            if (fieldModelController) {
              return !fieldModelController.$pristine && fieldModelController.$invalid && (fieldModelController.$dirty || this.attempted);
            } else {
              return formController && !formController.$pristine && formController.$invalid && (formController.$dirty || this.attempted);
            }
          };
        }],
