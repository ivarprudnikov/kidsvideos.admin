...
(function (angular) {
  ...
  'AddVideoModalController', [
    ...
    function ($window, $timeout, $interval, $scope, $modalInstance, configuration, videoActivity,
      ...
      $q.all({ video : loadVideo(), playlists : loadPlaylists() }).then(function (results) {
        $timeout(function () {
      ...
      $scope.addVideo = function () {
        ...
        PlaylistFactory.addVideo(queryParams, postData, function (responseData, responseHeaders) {
